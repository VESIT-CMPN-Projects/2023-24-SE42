	...
	$sql = "SELECT * FROM donor WHERE id = ".$_SESSION['user_id']."";
			...
			if(isset($_POST['submit'])){
					...
					if(isset($_POST['city']) && !empty($_POST['city'])){
						...
						$cityError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
						<strong>Please fill the city feilds.</strong>
						<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						<span aria-hidden="true">&times; </span>
						</button>
						</div>';
					...
					if(isset($_POST['email']) && !empty($_POST['email'])){
						...
						$emailError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
						<strong>Please fill the email feilds.</strong>
						<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						<span aria-hidden="true">&times; </span>
						</button>
						</div>';
					...
					if( isset($name) && isset($blood_group) && isset($gender) && isset($day) && isset($month) && isset($year) && isset($email) && isset($contact) && isset($city)){
						...
						if(mysqli_query($connection, $sql)){
							...
							$updateSuccess = '<div class="alert alert-success alert-dismissible fadeshow" role="alert">
		...
		if(mysqli_query($connection, $sql)){
			$PasswordSuccess = '<div class="alert alert-success alert-dismissible fade show"
		role="alert">
...
<?php
		...
		$PasswordError = '<div class="alert alert-danger alert-dismissible fade show"
		role="alert">
		<strong>Data not updated Try again.</strong>
		<button type="button" class="close" data-dismiss="alert"
		aria-label="Close">
...
<style>
	...
	<?php if(isset($cityError)) echo $cityError;  ?>
				...
				<div class="card col-md-6 offset-md-3">
					...
					if(isset($PasswordSuccess)) echo $PasswordSuccess;
					?>
