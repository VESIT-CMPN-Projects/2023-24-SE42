...
<?php 
	...
	if(isset($_POST['date'])){
		...
		<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Are you sure you want to donate blood?</strong>
	...
	if(isset($_POST['userID'])){
		...
		$submitError = '<div class="alert alert-danger alert-dismissible fade show"
		role="alert">
				...
				<div class="col-md-12 col-md-push-1">
					<div class="panel panel-default" style="padding: 20px;">
						<div class="panel-body">
							...
							<p class="text-center">Here you can manage and update your profile</p>
							...
							if($saveDate == '0'){
								...
								<span class="name">Congratualation!!</span>
